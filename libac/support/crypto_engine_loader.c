...
#include "../ce-wpa/crypto_engine.h"
#include "../support/crypto_engine_loader.h"
#include "../support/common.h"
#include "../cpu/trampoline.h"
...
#else
int (*dso_ac_crypto_engine_init)(ac_crypto_engine_t * engine) = nullptr;
void (*dso_ac_crypto_engine_destroy)(ac_crypto_engine_t * engine) = nullptr;
void (*dso_ac_crypto_engine_set_essid)(ac_crypto_engine_t * engine,
									   const uint8_t * essid)
	= nullptr;
int (*dso_ac_crypto_engine_thread_init)(ac_crypto_engine_t * engine,
...
void (*dso_ac_crypto_engine_thread_destroy)(ac_crypto_engine_t * engine,
											int threadid)
	= nullptr;
int (*dso_ac_crypto_engine_simd_width)(void) = nullptr;
int (*dso_ac_crypto_engine_wpa_crack)(
	ac_crypto_engine_t * engine,
	const wpapsk_password key[MAX_KEYS_PER_CRYPT_SUPPORTED],
	const uint8_t eapol[256],
...
void (*dso_ac_crypto_engine_set_pmkid_salt)(ac_crypto_engine_t * engine,
											...
											int threadid)
	= nullptr;
int (*dso_ac_crypto_engine_supported_features)(void) = nullptr;
uint8_t * (*dso_ac_crypto_engine_get_pmk)(ac_crypto_engine_t * engine,
										  int threadid,
										  int index)
	= nullptr;
...
EXPORT int ac_crypto_engine_loader_get_available(void)
{
...
#endif
	REQUIRE(working_directory != nullptr);
	...
	while ((entry = readdir(dsos)) != nullptr)
	{
...
EXPORT int ac_crypto_engine_loader_load(int flags)
{
	...
	REQUIRE(module_filename != nullptr);
...
EXPORT void ac_crypto_engine_loader_unload(void)
{
	...
	dso_ac_crypto_engine_init = nullptr;
	dso_ac_crypto_engine_destroy = nullptr;
	dso_ac_crypto_engine_thread_init = nullptr;
	dso_ac_crypto_engine_thread_destroy = nullptr;
	dso_ac_crypto_engine_set_essid = nullptr;
	dso_ac_crypto_engine_simd_width = nullptr;
	dso_ac_crypto_engine_wpa_crack = nullptr;
	dso_ac_crypto_engine_calc_pke = nullptr;
	dso_ac_crypto_engine_supported_features = nullptr;
#endif
}
