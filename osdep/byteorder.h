 ...
 *
 *  Copyright (C) 2009-2022 Thomas d'Otreppe <tdotreppe@air.org>
 *
...
#define AIR_LITTLE_ENDIAN LITTLE_ENDIAN
#elif defined(__LITTLE_ENDIAN)
#define AIR_LITTLE_ENDIAN __LITTLE_ENDIAN
#elif defined(_LITTLE_ENDIAN)
#define AIR_LITTLE_ENDIAN _LITTLE_ENDIAN
#endif

#if defined(BIG_ENDIAN)
#define AIR_BIG_ENDIAN BIG_ENDIAN
#elif defined(__BIG_ENDIAN)
#define AIR_BIG_ENDIAN __BIG_ENDIAN
#elif defined(_BIG_ENDIAN)
#define AIR_BIG_ENDIAN _BIG_ENDIAN
#endif

#if !defined(AIR_LITTLE_ENDIAN) && !defined(AIR_BIG_ENDIAN)
#error Impossible to determine endianness (Little or Big endian), please contact the author.
#endif

#if defined(BYTE_ORDER)
#if (BYTE_ORDER == AIR_LITTLE_ENDIAN)
#define AIR_BYTE_ORDER AIR_LITTLE_ENDIAN
#elif (BYTE_ORDER == AIR_BIG_ENDIAN)
#define AIR_BYTE_ORDER AIR_BIG_ENDIAN
#endif
#elif defined(__BYTE_ORDER)
#if (__BYTE_ORDER == AIR_LITTLE_ENDIAN)
#define AIR_BYTE_ORDER AIR_LITTLE_ENDIAN
#elif (__BYTE_ORDER == AIR_BIG_ENDIAN)
#define AIR_BYTE_ORDER AIR_BIG_ENDIAN
#endif
#elif defined(_BYTE_ORDER)
#if (_BYTE_ORDER == AIR_LITTLE_ENDIAN)
#define AIR_BYTE_ORDER AIR_LITTLE_ENDIAN
#elif (_BYTE_ORDER == AIR_BIG_ENDIAN)
#define AIR_BYTE_ORDER AIR_BIG_ENDIAN
#endif
#endif

#ifndef AIR_BYTE_ORDER
#error Impossible to determine endianness (Little or Big endian), please contact the author.
#endif

#if (AIR_BYTE_ORDER == AIR_LITTLE_ENDIAN)

#ifndef AIR_BYTE_ORDER_DEFINED
#define __be64_to_cpu(x) ___my_swab64(x)
#define __be32_to_cpu(x) ___my_swab32(x)
#define __be16_to_cpu(x) ___my_swab16(x)
#define __cpu_to_be64(x) ___my_swab64(x)
...
#if (AIR_BYTE_ORDER == AIR_BIG_ENDIAN)
