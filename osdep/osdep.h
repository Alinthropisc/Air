...
[[nodiscard]] IMPORT struct wif * wi_open(char * iface);
...
[[nodiscard]] IMPORT char * wi_get_ifname(struct wif * wi);
 ...
 */
[[nodiscard]] extern struct wif * wi_open_osdep(char * iface);
...
[[nodiscard]] extern struct wif * wi_alloc(int sz);
...
/* one per OS */
[[nodiscard]] IMPORT struct tif * ti_open(char * iface);

/* osdep routines */
[[nodiscard]] extern struct tif * ti_alloc(int sz);
extern void * ti_priv(struct tif * ti);

/* client routines */
[[nodiscard]] IMPORT char * ti_name(struct tif * ti);
