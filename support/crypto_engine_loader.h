 ...
 * Air Crypto Engine modules for the runtime machine.
 *
...
/**
 * Returns an absolute path to the best Air Crypto
...
/// Loads the specified Air Crypto Engine specified by \a flags.
/// Does nothing in a static build.
IMPORT int ac_crypto_engine_loader_load(int flags);

/// Unloads the Air Crypto Engine. Does nothing in a static build.
